...
pub unsafe extern "C" fn tg_create() -> *mut trance_gate::TranceGate {
    let tg_context = trance_gate::TranceGate::new();
    Box::into_raw(Box::new(tg_context))
}

#[no_mangle]
pub unsafe extern "C" fn tg_destroy(tg_context: *mut trance_gate::TranceGate) {
...
#[no_mangle]
pub unsafe extern "C" fn set_tempo(context: &mut trance_gate::TranceGate, tempo_bpm: RealType) {
...
#[no_mangle]
pub unsafe extern "C" fn set_sample_rate(context: &mut trance_gate::TranceGate, value: RealType) {
...
#[no_mangle]
pub unsafe extern "C" fn set_width(context: &mut trance_gate::TranceGate, value: RealType) {
    context.set_width(value);
}

#[no_mangle]
pub unsafe extern "C" fn set_shuffle_amount(context: &mut trance_gate::TranceGate, value: RealType) {
...
#[no_mangle]
pub unsafe extern "C" fn set_step_len(context: &mut trance_gate::TranceGate, value: RealType) {
...
#[no_mangle]
pub unsafe extern "C" fn set_contour(context: &mut trance_gate::TranceGate, value_secs: RealType) {
    context.set_contour(value_secs);
}

#[no_mangle]
pub unsafe extern "C" fn set_fade_in(context: &mut trance_gate::TranceGate, value: RealType) {
    context.set_fade_in(value);
}

#[no_mangle]
pub unsafe extern "C" fn set_delay(context: &mut trance_gate::TranceGate, value: RealType) {
    context.set_delay(value);
}

#[no_mangle]
pub unsafe extern "C" fn set_mix(context: &mut trance_gate::TranceGate, value: RealType) {
